...
import com.deep.batch.processor.PersonItenProcessor;
...
public class BatchConfig {
	...
	@Bean
	public Step step1(){
		return stepBuilderFactory.get("step1").<Person,Person>chunk(400).reader(reader()).processor(processor()).writer(writer()).build();
	}
